...
//                 },
//               }}
//               className="w-[200%] h-full flex justify-end items-end"
//             >
//               <SparklesCore
...
//               {/* <div className="text-white">Onit</div> */}
//               <SparklesCore
//                 background="transparent"
//                 minSize={0.4}
//                 maxSize={1}
...
// <div className="text-sm text-white absolute -right-[2px] -top-[2px] pointer-events-none animate-pulse group-hover/cover:hidden group-hover/cover:opacity-100 h-2 w-2 rounded-full bg-white">s</div>
...
//     <div
//     className={cn(
//       "pointer-events-none animate-pulse group-hover/cover:hidden group-hover/cover:opacity-100 h-2 w-2 rounded-full bg-white",
//       className
//     )}
//   ></div>
//   );
