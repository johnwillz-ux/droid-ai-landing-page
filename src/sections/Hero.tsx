...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="mb-5">
          <h1 className="font-tomorrow text-4xl md:text-7xl font-semibold text-center tracking-tighter  bg-[radial-gradient(100%_100%_at_top_left,_white,_white,_rgba(226,_83,_25,_0.5))] text-transparent bg-clip-text">
            Step Into
            <div className="mt-5">
        ...
        <p className="max-w-lg mx-auto mb-5 text-base font-light text-center font-tomorrow md:text-xl text-neutral-700 dark:text-neutral-200 w-[90%] ">
          Transform Yourself into a Cyberpunk Icon. Join the Waitlist Today!
        </p>
